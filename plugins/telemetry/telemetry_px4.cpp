...
PX4TelemetryImpl::PX4TelemetryImpl() :
    _position_mutex(),
...
void PX4TelemetryImpl::init()
{
    using namespace std::placeholders; // for `_1`

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_GLOBAL_POSITION_INT,
        std::bind(&PX4TelemetryImpl::process_global_position_int, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_HOME_POSITION,
        std::bind(&PX4TelemetryImpl::process_home_position, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_ATTITUDE_QUATERNION,
        std::bind(&PX4TelemetryImpl::process_attitude_quaternion, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_MOUNT_ORIENTATION,
        std::bind(&PX4TelemetryImpl::process_mount_orientation, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_GPS_RAW_INT,
        std::bind(&PX4TelemetryImpl::process_gps_raw_int, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_EXTENDED_SYS_STATE,
        std::bind(&PX4TelemetryImpl::process_extended_sys_state, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_SYS_STATUS,
        std::bind(&PX4TelemetryImpl::process_sys_status, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_HEARTBEAT,
        std::bind(&PX4TelemetryImpl::process_heartbeat, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_mavlink_message_handler(
        MAVLINK_MSG_ID_RC_CHANNELS,
        std::bind(&PX4TelemetryImpl::process_rc_channels, this, _1), (void *)this);

    ((PX4DeviceImpl*)_parent)->register_timeout_handler(
        std::bind(&PX4TelemetryImpl::receive_rc_channels_timeout, this), 1.0, (const void *)this);

    // FIXME: The calibration check should eventually be better than this.
    //        For now, we just do the same as QGC does.

    ((PX4DeviceImpl*)_parent)->get_param_int_async(std::string("CAL_GYRO0_ID"),
                                 std::bind(&PX4TelemetryImpl::receive_param_cal_gyro,
                                           this,
                                           std::placeholders::_1,
                                           std::placeholders::_2));

    ((PX4DeviceImpl*)_parent)->get_param_int_async(std::string("CAL_ACC0_ID"),
                                 std::bind(&PX4TelemetryImpl::receive_param_cal_accel,
                                           this,
                                           std::placeholders::_1,
                                           std::placeholders::_2));

    ((PX4DeviceImpl*)_parent)->get_param_int_async(std::string("CAL_MAG0_ID"),
    ...
    ((PX4DeviceImpl*)_parent)->get_param_float_async(std::string("SENS_BOARD_X_OFF"),
...
void PX4TelemetryImpl::deinit()
{
    ((PX4DeviceImpl*)_parent)->unregister_all_mavlink_message_handlers((void *)this);
}

Telemetry::Result PX4TelemetryImpl::set_rate_position(double rate_hz)
{
    _position_rate_hz = rate_hz;
    double max_rate_hz = std::max(_position_rate_hz, _ground_speed_ned_rate_hz);

    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_GLOBAL_POSITION_INT, max_rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_home_position(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_HOME_POSITION, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_in_air(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_EXTENDED_SYS_STATE, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_attitude(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_ATTITUDE_QUATERNION, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_camera_attitude(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_MOUNT_ORIENTATION, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_ground_speed_ned(double rate_hz)
{
...
Telemetry::Result PX4TelemetryImpl::set_rate_gps_info(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_GPS_RAW_INT, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_battery(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_SYS_STATUS, rate_hz));
}

Telemetry::Result PX4TelemetryImpl::set_rate_rc_status(double rate_hz)
{
    return telemetry_result_from_command_result(
               ((PX4DeviceImpl*)_parent)->set_msg_rate(MAVLINK_MSG_ID_RC_CHANNELS, rate_hz));
}

void PX4TelemetryImpl::set_rate_position_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _position_rate_hz = rate_hz;
    double max_rate_hz = std::max(_position_rate_hz, _ground_speed_ned_rate_hz);

    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_GLOBAL_POSITION_INT,
        max_rate_hz,
        std::bind(&PX4TelemetryImpl::command_result_callback, std::placeholders::_1, callback));

}

void PX4TelemetryImpl::set_rate_home_position_async(double rate_hz,
...
void PX4TelemetryImpl::set_rate_in_air_async(double rate_hz, Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_EXTENDED_SYS_STATE,
        rate_hz,
...
void PX4TelemetryImpl::set_rate_attitude_async(double rate_hz, Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_ATTITUDE_QUATERNION,
        rate_hz,
...
void PX4TelemetryImpl::set_rate_camera_attitude_async(double rate_hz,
                                                   Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_MOUNT_ORIENTATION,
...
void PX4TelemetryImpl::set_rate_ground_speed_ned_async(double rate_hz,
                                                    Telemetry::result_callback_t callback)
{
    _ground_speed_ned_rate_hz = rate_hz;
    double max_rate_hz = std::max(_position_rate_hz, _ground_speed_ned_rate_hz);
...
void PX4TelemetryImpl::set_rate_gps_info_async(double rate_hz, Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_GPS_RAW_INT,
        rate_hz,
...
void PX4TelemetryImpl::set_rate_battery_async(double rate_hz, Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_SYS_STATUS,
        rate_hz,
...
void PX4TelemetryImpl::set_rate_rc_status_async(double rate_hz, Telemetry::result_callback_t callback)
{
    ((PX4DeviceImpl*)_parent)->set_msg_rate_async(
        MAVLINK_MSG_ID_RC_CHANNELS,
        rate_hz,
...
Telemetry::Result PX4TelemetryImpl::telemetry_result_from_command_result(
...
void PX4TelemetryImpl::command_result_callback(MavlinkCommands::Result command_result,
...
void PX4TelemetryImpl::process_global_position_int(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_home_position(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_attitude_quaternion(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_mount_orientation(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_gps_raw_int(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_extended_sys_state(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_sys_status(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_heartbeat(const mavlink_message_t &message)
{
...
void PX4TelemetryImpl::process_rc_channels(const mavlink_message_t &message)
{
    ...
    ((PX4DeviceImpl*)_parent)->refresh_timeout_handler(this);
}

Telemetry::FlightMode PX4TelemetryImpl::to_flight_mode_from_custom_mode(uint32_t custom_mode)
{
...
void PX4TelemetryImpl::receive_rc_channels_timeout()
{
    const bool rc_ok = false;
    set_rc_status(rc_ok, 0.0f);
}

Telemetry::Position PX4TelemetryImpl::get_position() const
{
    std::lock_guard<std::mutex> lock(_position_mutex);
    return _position;
}

void PX4TelemetryImpl::set_position(Telemetry::Position position)
{
    std::lock_guard<std::mutex> lock(_position_mutex);
    _position = position;
}

Telemetry::Position PX4TelemetryImpl::get_home_position() const
{
    std::lock_guard<std::mutex> lock(_home_position_mutex);
    return _home_position;
}

void PX4TelemetryImpl::set_home_position(Telemetry::Position home_position)
{
    std::lock_guard<std::mutex> lock(_home_position_mutex);
    _home_position = home_position;
}

bool PX4TelemetryImpl::in_air() const
{
    return _in_air;
}

bool PX4TelemetryImpl::armed() const
{
    return _armed;
}

void PX4TelemetryImpl::set_in_air(bool in_air)
{
    _in_air = in_air;
}

void PX4TelemetryImpl::set_armed(bool armed)
{
    _armed = armed;
}

Telemetry::Quaternion PX4TelemetryImpl::get_attitude_quaternion() const
{
    std::lock_guard<std::mutex> lock(_attitude_quaternion_mutex);
    return _attitude_quaternion;
}

Telemetry::EulerAngle PX4TelemetryImpl::get_attitude_euler_angle() const
{
    std::lock_guard<std::mutex> lock(_attitude_quaternion_mutex);
...
void PX4TelemetryImpl::set_attitude_quaternion(Telemetry::Quaternion quaternion)
{
    std::lock_guard<std::mutex> lock(_attitude_quaternion_mutex);
    _attitude_quaternion = quaternion;
}

Telemetry::Quaternion PX4TelemetryImpl::get_camera_attitude_quaternion() const
{
...
Telemetry::EulerAngle PX4TelemetryImpl::get_camera_attitude_euler_angle() const
{
    std::lock_guard<std::mutex> lock(_camera_attitude_euler_angle_mutex);
...
void PX4TelemetryImpl::set_camera_attitude_euler_angle(Telemetry::EulerAngle euler_angle)
{
    std::lock_guard<std::mutex> lock(_camera_attitude_euler_angle_mutex);
    _camera_attitude_euler_angle = euler_angle;
}

Telemetry::GroundSpeedNED PX4TelemetryImpl::get_ground_speed_ned() const
{
    std::lock_guard<std::mutex> lock(_ground_speed_ned_mutex);
    return _ground_speed_ned;
}

void PX4TelemetryImpl::set_ground_speed_ned(Telemetry::GroundSpeedNED ground_speed_ned)
{
    std::lock_guard<std::mutex> lock(_ground_speed_ned_mutex);
    _ground_speed_ned = ground_speed_ned;
}

Telemetry::GPSInfo PX4TelemetryImpl::get_gps_info() const
{
    std::lock_guard<std::mutex> lock(_gps_info_mutex);
    return _gps_info;
}

void PX4TelemetryImpl::set_gps_info(Telemetry::GPSInfo gps_info)
{
    std::lock_guard<std::mutex> lock(_gps_info_mutex);
    _gps_info = gps_info;
}

Telemetry::Battery PX4TelemetryImpl::get_battery() const
{
    std::lock_guard<std::mutex> lock(_battery_mutex);
    return _battery;
}

void PX4TelemetryImpl::set_battery(Telemetry::Battery battery)
{
    std::lock_guard<std::mutex> lock(_battery_mutex);
    _battery = battery;
}

Telemetry::FlightMode PX4TelemetryImpl::get_flight_mode() const
{
    std::lock_guard<std::mutex> lock(_flight_mode_mutex);
    return _flight_mode;
}

void PX4TelemetryImpl::set_flight_mode(Telemetry::FlightMode flight_mode)
{
    std::lock_guard<std::mutex> lock(_flight_mode_mutex);
    _flight_mode = flight_mode;
}

Telemetry::Health PX4TelemetryImpl::get_health() const
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    return _health;
}

bool PX4TelemetryImpl::get_health_all_ok() const
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
Telemetry::RCStatus PX4TelemetryImpl::get_rc_status() const
{
    std::lock_guard<std::mutex> lock(_rc_status_mutex);
    return _rc_status;
}

void PX4TelemetryImpl::set_health_local_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.local_position_ok = ok;
}

void PX4TelemetryImpl::set_health_global_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.global_position_ok = ok;
}

void PX4TelemetryImpl::set_health_home_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.home_position_ok = ok;
}

void PX4TelemetryImpl::set_health_gyrometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.gyrometer_calibration_ok = ok;
}

void PX4TelemetryImpl::set_health_accelerometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.accelerometer_calibration_ok = ok;
}

void PX4TelemetryImpl::set_health_magnetometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.magnetometer_calibration_ok = ok;
}

void PX4TelemetryImpl::set_health_level_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
    _health.level_calibration_ok = ok;
}

void PX4TelemetryImpl::set_rc_status(bool available, float signal_strength_percent)
{
    std::lock_guard<std::mutex> lock(_rc_status_mutex);
...
void PX4TelemetryImpl::position_async(Telemetry::position_callback_t &callback)
{
    _position_subscription = callback;
}

void PX4TelemetryImpl::home_position_async(Telemetry::position_callback_t &callback)
{
    _home_position_subscription = callback;
}

void PX4TelemetryImpl::in_air_async(Telemetry::in_air_callback_t &callback)
{
    _in_air_subscription = callback;
}

void PX4TelemetryImpl::armed_async(Telemetry::armed_callback_t &callback)
{
    _armed_subscription = callback;
}

void PX4TelemetryImpl::attitude_quaternion_async(Telemetry::attitude_quaternion_callback_t &callback)
{
    _attitude_quaternion_subscription = callback;
}

void PX4TelemetryImpl::attitude_euler_angle_async(Telemetry::attitude_euler_angle_callback_t
                                               &callback)
{
    _attitude_euler_angle_subscription = callback;
}

void PX4TelemetryImpl::camera_attitude_quaternion_async(Telemetry::attitude_quaternion_callback_t
                                                     &callback)
{
    _camera_attitude_quaternion_subscription = callback;
}

void PX4TelemetryImpl::camera_attitude_euler_angle_async(Telemetry::attitude_euler_angle_callback_t
                                                      &callback)
{
    _camera_attitude_euler_angle_subscription = callback;
}

void PX4TelemetryImpl::ground_speed_ned_async(Telemetry::ground_speed_ned_callback_t &callback)
{
    _ground_speed_ned_subscription = callback;
}

void PX4TelemetryImpl::gps_info_async(Telemetry::gps_info_callback_t &callback)
{
    _gps_info_subscription = callback;
}

void PX4TelemetryImpl::battery_async(Telemetry::battery_callback_t &callback)
{
    _battery_subscription = callback;
}

void PX4TelemetryImpl::flight_mode_async(Telemetry::flight_mode_callback_t &callback)
{
    _flight_mode_subscription = callback;
}

void PX4TelemetryImpl::health_async(Telemetry::health_callback_t &callback)
{
    _health_subscription = callback;
}

void PX4TelemetryImpl::health_all_ok_async(Telemetry::health_all_ok_callback_t &callback)
{
    _health_all_ok_subscription = callback;
}

void PX4TelemetryImpl::rc_status_async(Telemetry::rc_status_callback_t &callback)
{
